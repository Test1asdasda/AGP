...
<body class="font-sans antialiased  dark:text-white/50">
  <header class="">
    ...
    <nav class="relative px-4 py-4 flex justify-between items-center">
      <div class="">
        <div class="flex">
          <img class="" width="120" src="{{ asset('../img/apple-touch-icon-removebg-preview.png') }}" /></a>
          <div class="sm:w-[600px]">
            <h1 class="sm:text-[#124076] text-[#124076] sm:text-2xl text-[18px]">INSTITUTO POLÍTECNICO PRIVADO AGP</h1>
            <h1 class="sm:text-[#124076] text-[#124076] text-[18px]">ENSINO PARTICULAR</h1>
          </div>
        </div>
      </div>
      ...
      <ul class="hidden absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2 lg:flex lg:mx-auto lg:flex lg:items-center lg:w-auto lg:space-x-6">
        ...
        <li><a class="text-sm text-black " href="#">Area Pedagógica</a></li>
        <li class="text-gray-300">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" class="w-4 h-4 current-fill" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 5v0m0 7v0m0 7v0m0-13a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2z" />
          </svg>
        </li>
        <li><a class="text-sm text-black " href="#">Cursos</a></li>
        <li class="text-gray-300">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" class="w-4 h-4 current-fill" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 5v0m0 7v0m0 7v0m0-13a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2z" />
          </svg>
      ...
      <nav class="fixed top-0 left-0 bottom-0 flex flex-col w-5/6 max-w-sm py-6 px-6 bg-white border-r overflow-y-auto">
        ...
        <div>
          <ul>
            ...
            <li class="mb-1">
              <a class="block p-4 text-sm font-semibold text-gray-400 hover:bg-blue-50 hover:text-blue-600 rounded" href="#">Area Pedagógica</a>
            </li>
            <li class="mb-1">
              <a class="block p-4 text-sm font-semibold text-gray-400 hover:bg-blue-50 hover:text-blue-600 rounded" href="#">Cursos</a>
            </li>

            <li class="mb-1">
              <a class="block p-4 text-sm font-semibold text-gray-400 hover:bg-blue-50 hover:text-blue-600 rounded" href="#">Sec</a>
            </li>
          </ul>
        </div>
        <div class="mt-auto">
  ...
  <div class="sm:mt-40 mx-auto">
    ...
    <div class=" ">
      <div class="sm:flex sm:border-white sm:border-2 border-black border-2 ">
        <div class="m-10">
               <img src="{{ asset('../img/saude.jpg') }}" alt="">
        </div>
        <div class="m-20">
          <h1 class="text-black text-center">Enfermagem Geral</h1>
          <h1 class="text-black text-[20px] font-bold">A enfermagem geral abrange uma ampla gama de cuidados de saúde, desde a prevenção até o tratamento de doenças. Os enfermeiros desempenham um papel crucial na promoção da saúde, na administração de medicamentos, no monitoramento dos sinais vitais dos pacientes e no fornecimento de apoio emocional. Sua dedicação
            e habilidades contribuem significativamente para o bem-estar e recuperação dos pacientes em hospitais, clínicas, lares de idosos e
            outros ambientes de cuidados de saúde.</h1>
        </div>
      </div>
      <div class="sm:flex sm:border-white sm:border-2 border-black border-2">
        <div class="m-20">
          <h1 class="text-black text-center">Informática de gestão</h1>
          <h1 class="text-black text-[20px] font-bold">A informática de gestão é uma disciplina que combina conhecimentos de informática e gestão para otimizar processos e tomadas de decisão nas organizações. Envolve a utilização de sistemas de informação e tecnologias para coletar, armazenar, processar e analisar dados relevantes para o planejamento, controle e direção das atividades empresariais. Seu objetivo é aumentar a eficiência,
            produtividade e competitividade das organizações, fornecendo informações precisas e
            oportunas para os gestores.</h1>
        </div>
        <div class="m-10">
              <img width="1700" src="{{ asset('../img/inf.jpg') }}" alt="">
        </div>
        </div>

      <div class="sm:flex sm:border-white sm:border-2 border-black border-2">
      <div class="m-10">
           <img   src="{{ asset('../img/op.jpg') }}" alt="">

        </div>
        <div class="m-20">
          <h1 class="text-black text-center">Operador de Informática</h1>
          <h1 class="text-black text-[20px] font-bold">O operador de informática é responsável pela execução de tarefas básicas relacionadas ao uso de computadores e softwares. Isso inclui a digitação de documentos, a criação de planilhas, o envio de e-mails, a realização de pesquisas na internet e outras atividades essenciais para o funcionamento diário de uma empresa ou organização. Geralmente, o operador de informática possui habilidades básicas de informática e é
            capaz de utilizar programas de produtividade como o Microsoft Office ou o Google Workspace.</h1>
        </div>
      </div>
      <div class="sm:flex sm:border-white sm:border-2 border-black border-2">
        <div class="m-20">
          <h1 class="text-black text-center">Recursos Humanos</h1>
          <h1 class="text-black text-[20px] font-bold">Recursos humanos é uma área fundamental nas organizações, dedicada à gestão do capital humano. Isso envolve recrutamento, seleção, treinamento, desenvolvimento e gerenciamento dos colaboradores. Os profissionais de RH são responsáveis por criar um ambiente de trabalho saudável, promover o bem-estar dos funcionários e garantir o alinhamento entre as metas organizacionais e as necessidades individuais dos colaboradores. Eles desempenham um papel crucial na construção
             de equipes eficazes e no impulsionamento do crescimento e sucesso da empresa.</h1>
        </div>
        <div class="m-10">
            <img src="{{ asset('../img/rh.jpg') }}" alt="">
        </div>
        </div>
    ...
    <!-- Uniformes -->
    <div>
      <h1 class="text-black">Uniformes</h1>
      <div></div>
    </div>
    <!-- Actividades -->
    <div>
      <h1 class="text-black">Actividades Extra Curriculares</h1>
    </div>
  ...
  <script>
    ...
    (() => { // webpackBootstrap
      ...
      */
      ...
      var modifierPhases = [beforeRead, read, afterRead, beforeMain, main, afterMain, beforeWrite, write, afterWrite];; // CONCATENATED MODULE: ./node_modules/@popperjs/core/lib/utils/orderModifiers.js
